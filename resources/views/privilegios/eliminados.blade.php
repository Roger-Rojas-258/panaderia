...
<div class="row">
  <div class="col">
    <div class="card shadow">
      ...
      <div class="card-header border-0">
        <a href="{{route('privilegio.index')}}" class="btn btn-warning me-md-1 btn-sm p-2"> Regresar</a>
      </div>
          ...
          <tbody>
            @foreach ($tipos as $tipo)
              <tr>
                ...
                <td>
                  <a href="#" class="eliminar-tipo" data-id="{{$tipo->id_privilegio}}" data-bs-toggle="modal" data-bs-target="#modal-confirma" rel="tooltip" data-placement="top" title="Eliminar">

          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Registrar repartidor</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group focused">
                        ...
                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control form-control-alternative" placeholder="materno">
                      </div>
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Total propina: </label>
                        <input type="text" id="total_propina" name="total_propina" class="form-control form-control-alternative" placeholder="sueldo">
                      </div>
                      <div class="form-group focused">

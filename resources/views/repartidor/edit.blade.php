          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0">Editar repartidor</h3>
                </div>
              </div>
            </div>
            <div class="card-body">
              <form action="{{route('repartidor.update', $tipo->id_repartidor)}}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Fecha nacimiento: </label>
                        <input type="text" id="nombre" name="nombre" class="form-control form-control-alternative" placeholder="nombre" value="{{$tipo->fecha_nacimiento}}">
                      </div>

                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">total propina: </label>
                        <input type="text" id="total_propina" name="total_propina" class="form-control form-control-alternative" placeholder="nombre" value="{{$tipo->total_propina}}">
                      </div>
                ...
                <br>
                <div class="pl-lg-4">
                  <a href="{{route('repartidor.index')}}" class="btn btn-secondary me-md-1">Regresar</a>

  ...
  <div class="col">
    <div class="card shadow">
      <div class="card-header border-0">
        <h3 class="mb-0">Eliminados repartidor</h3>
      </div>
      <div class="card-header border-0">
        <a href="{{route('repartidor.index')}}" class="btn btn-warning me-md-1 btn-sm p-2"> Regresar</a>
      </div>
        ...
        <table class="table align-items-center table-flush">
          ...
          <tbody>
            @foreach ($tipos as $tipo)
              <tr>
                <td>
                  <span class="badge badge-dot mr-4">{{$tipo->id_repartidor}}</span>
                </td>
                <td>
                ...
                <td>
                  <span class="badge badge-dot mr-4">{{$tipo->total_propina}}</span>
                </td>
                <td>
                ...
                <td>
                  <a href="#" class="eliminar-tipo" data-id="{{$tipo->id_repartidor}}" data-bs-toggle="modal" data-bs-target="#modal-confirma" rel="tooltip" data-placement="top" title="Eliminar">
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            elementosEliminar.forEach(function (elemento) {
                elemento.addEventListener('click', function (event) {
                    ...
                    const url = "{{ route('repartidor.restablecer', ['tipoId' => ':tipoId']) }}".replace(':tipoId', tipoId);

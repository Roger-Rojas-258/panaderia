            ...
            @foreach ($tipos as $tipo)
              <tr>
                ...
                <td>
                  ...
                  <form id="formEliminar{{$tipo->id_repartidor}}" action="{{route('repartidor.destroy',$tipo->id_repartidor)}}" method="POST">
                    @csrf
                    @method('DELETE')
                    <td>
                      <a href="{{route('repartidor.edit', $tipo->id_repartidor)}}">

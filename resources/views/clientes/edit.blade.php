...
<div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form action="{{route('cliente.update', $tipo->id_cliente)}}" method="POST">
                @csrf
                @method('PUT')
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      ...
                      <div class="form-group focused">
                        ...
                        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="form-control form-control-alternative" value="{{$tipo->fecha_nacimiento}}">
                      </div>
                ...
                <br>
                <div class="pl-lg-4">
                  <a href="{{route('cliente.index')}}" class="btn btn-secondary me-md-1">Regresar</a>
